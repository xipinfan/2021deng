    ...
    return function e(t, n, r) {
        ...
        1: [function (require, module, exports) {
            ...
            EventEmitter.prototype.setMaxListeners = function (n) {
                if (!isNumber(n) || n < 0 || isNaN(n)) throw TypeError(
            ...
            EventEmitter.prototype.emit = function (type) {
                ...
                if (type === "error") {
                    if (!this._events.error || isObject(this._events.error) && !this._events.error
                        .length) {
                        er = arguments[1];
            ...
            EventEmitter.prototype.addListener = function (type, listener) {
                ...
                if (!this._events) this._events = {};
                if (this._events.newListener) this.emit("newListener", type, isFunction(
                ...
                if (isObject(this._events[type]) && !this._events[type].warned) {
                    ...
                    if (m && m > 0 && this._events[type].length > m) {
                        ...
                        console.error("(node) warning: possible EventEmitter memory " +
                            ...
                            "Use emitter.setMaxListeners() to increase limit.", this._events[
                                type].length);
            ...
            EventEmitter.prototype.removeListener = function (type, listener) {
                ...
                length = list.length;
                position = -1;
                if (list === listener || isFunction(list.listener) && list.listener ===
                    listener) {
            ...
            GIF = function (superClass) {
                ...
                GIF.prototype.addFrame = function (image, options) {
                    ...
                    if (typeof ImageData !== "undefined" && ImageData !== null && image instanceof ImageData) {
                        ...
                        CanvasRenderingContext2D !== null && image instanceof CanvasRenderingContext2D ||
                        typeof WebGLRenderingContext !== "undefined" &&
                        WebGLRenderingContext !== null && image instanceof WebGLRenderingContext
                    ) {
                        if (options.copy) {
                ...
                GIF.prototype.render = function () {
                    ...
                    this.imageParts = function () {
                        var j, ref, results;
                        results = [];
                        for (i = j = 0, ref = this.frames.length; 0 <= ref ? j < ref :
                            j > ref; i = 0 <= ref ? ++j : --j) {
                            results.push(null)
                        }
                        return results
                    ...
                    if (this.options.globalPalette === true) {
                        ...
                        for (i = j = 0, ref = numWorkers; 0 <= ref ? j < ref : j > ref; i =
                            0 <= ref ? ++j : --j) {
                            this.renderNextFrame()
                        }
                    }
                ...
                GIF.prototype.spawnWorkers = function () {
                    ...
                    (function () {
                        results = [];
                        for (var j = ref = this.freeWorkers.length; ref <= numWorkers ?
                            j < numWorkers : j > numWorkers; ref <= numWorkers ? j++ :
                            j--) {
                            results.push(j)
                        }
                        return results
                        ...
                        return function (i) {
                            ...
                            worker.onmessage = function (event) {
                                _this.activeWorkers.splice(_this.activeWorkers
                                    .indexOf(worker), 1);
                ...
                GIF.prototype.frameFinished = function (frame) {
                    var i, j, ref;
                    this.log("frame " + frame.index + " finished - " + this.activeWorkers.length +
                        " active");
                    this.finishedFrames++;
                    ...
                    if (this.options.globalPalette === true) {
                        ...
                        if (this.frames.length > 2) {
                            for (i = j = 1, ref = this.freeWorkers.length; 1 <= ref ? j <
                                ref : j > ref; i = 1 <= ref ? ++j : --j) {
                                this.renderNextFrame()
                            }
                        }
                    }
                ...
                GIF.prototype.finishRendering = function () {
                    var data, frame, i, image, j, k, l, len, len1, len2, len3, offset, page,
                        ref, ref1, ref2;
                    len = 0;
                    ref = this.imageParts;
                    ...
                    this.log("rendering finished - filesize " + Math.round(len / 1e3) +
                        "kb");
